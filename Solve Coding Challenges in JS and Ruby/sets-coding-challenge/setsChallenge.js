...
// Test cases
const arr1 = [1, 2, 3, 1, 5, 6, 7, 8, 5, 2];
console.log(find_duplicates(arr1)); // => [1, 5, 2]

const arr2 = [3, 501, 17, 23, -43, 67, 5, 888, -402, 235, 77, 99, 311, 1, -43];
console.log(find_duplicates(arr2)); // => [-43]
